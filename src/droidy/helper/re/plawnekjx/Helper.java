...
public class Helper {
	public static void main(String[] args) {
		if (args.length != 1) {
			System.err.println("Usage: plawnekjx-helper <instance-id>");
			System.exit(1);
			return;
		}
		...
		new File("/data/android/plawnekjx/plawnekjx-helper-" + instanceId + ".dex").delete();

		LocalServerSocket socket;
		try {
			socket = new LocalServerSocket("/plawnekjx-helper-" + instanceId);
		} catch (IOException e) {
