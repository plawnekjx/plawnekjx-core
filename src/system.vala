namespace Plawnekjx {
	namespace System {
		public extern static Plawnekjx.HostApplicationInfo get_frontmost_application (FrontmostQueryOptions options) throws Error;
		public extern static Plawnekjx.HostApplicationInfo[] enumerate_applications (ApplicationQueryOptions options);
		public extern static Plawnekjx.HostProcessInfo[] enumerate_processes (ProcessQueryOptions options);
	...
	public sealed class TemporaryDirectory {
		...
		public static string make_name () {
			var builder = new StringBuilder ("plawnekjx-");
			for (var i = 0; i != 16; i++)
