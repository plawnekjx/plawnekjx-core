...
const cm = new CModule(File.readAllBytes("./target/aarch64-unknown-none/release/plawnekjx-barebone-agent"));
//const cm = new CModule(File.readAllBytes("./target/aarch64-unknown-none/debug/plawnekjx-barebone-agent"));
