namespace Plawnekjx {
	...
	private sealed class HelperFactory {
		...
		public async HelperInstance obtain (Cancellable? cancellable) throws Error, IOError {
			...
			if (obtain_request == null) {
				...
				new Thread<bool> ("plawnekjx-helper-factory", obtain_worker);
			}
	...
	private sealed class ResourceStore {
		...
		public ResourceStore (TemporaryDirectory tempdir) throws Error {
			var helper_arm64 = add_helper ("arm64", Plawnekjx.Data.Helper.get_plawnekjx_helper_arm64_exe_blob (), tempdir);
			var helper_x86_64 = add_helper ("x86_64", Plawnekjx.Data.Helper.get_plawnekjx_helper_x86_64_exe_blob (), tempdir);
			var helper_x86 = add_helper ("x86", Plawnekjx.Data.Helper.get_plawnekjx_helper_x86_exe_blob (), tempdir);
		...
		private TemporaryFile add_helper (string name, Plawnekjx.Data.Helper.Blob blob, TemporaryDirectory tempdir) throws Error {
			var file = new TemporaryFile.from_stream (@"plawnekjx-helper-$name.exe",
