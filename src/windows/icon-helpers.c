...
GVariant *
_plawnekjx_icon_from_process_or_file (DWORD pid, WCHAR * filename, PlawnekjxIconSize size)
{
  GVariant * icon;

  icon = _plawnekjx_icon_from_process (pid, size);
  if (icon == NULL)
    icon = _plawnekjx_icon_from_file (filename, size);

  return icon;
}

GVariant *
_plawnekjx_icon_from_process (DWORD pid, PlawnekjxIconSize size)
{
  ...
  if (main_window != NULL)
  {
    ...
    else if (size == PLAWNEKJX_ICON_LARGE)
    {
  ...
  if (icon != NULL)
    result = _plawnekjx_icon_from_native_icon_handle (icon, size);

  return result;
}

GVariant *
_plawnekjx_icon_from_file (WCHAR * filename, PlawnekjxIconSize size)
{
  GVariant * result = NULL;
  SHFILEINFOW shfi = { 0, };
  UINT flags;
  ...
  if (shfi.hIcon != NULL)
  {
    result = _plawnekjx_icon_from_native_icon_handle (shfi.hIcon, size);
...
GVariant *
_plawnekjx_icon_from_resource_url (WCHAR * resource_url, PlawnekjxIconSize size)
{
  ...
  *p = L'\0';
  ...
  ret = ExtractIconExW (resource_file, resource_id, (size == PLAWNEKJX_ICON_LARGE) ? &icon : NULL, (size == PLAWNEKJX_ICON_SMALL) ? &icon : NULL, 1);
...
GVariant *
_plawnekjx_icon_from_native_icon_handle (HICON icon, PlawnekjxIconSize size)
{
  GVariant * result;
  HDC dc;
