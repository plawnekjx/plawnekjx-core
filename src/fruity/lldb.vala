[CCode (gir_namespace = "PlawnekjxLLDB", gir_version = "1.0")]
namespace Plawnekjx.LLDB {
	...
	public enum ASLR {
		...
		public static ASLR from_nick (string nick) throws Plawnekjx.Error {
	...
	public enum Signal {
		...
		public static Signal from_nick (string nick) throws Plawnekjx.Error {
	...
	public enum MachExceptionType {
		...
		public static MachExceptionType from_nick (string nick) throws Plawnekjx.Error {
