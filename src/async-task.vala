internal abstract class Plawnekjx.AsyncTask<T> : Object {
	...
	// FIXME: Work around Vala compiler bug where it fails to include plawnekjx-core.h
	[CCode (cname = "plawnekjx_get_main_context")]
