namespace Plawnekjx {
	...
	namespace ObjectPath {
		public const string HELPER = "/re/plawnekjx/Helper";
		public const string SYSTEM_SESSION_PROVIDER = "/re/plawnekjx/SystemSessionProvider";
	}
}
