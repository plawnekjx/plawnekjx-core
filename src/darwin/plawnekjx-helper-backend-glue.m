...
#define PLAWNEKJX_PSR_THUMB                  0x20
#define PLAWNEKJX_MAX_BREAKPOINTS            4
#define PLAWNEKJX_MAX_PAGE_POOL              8
...
typedef struct _PlawnekjxDispatchContext PlawnekjxDispatchContext;
typedef struct _PlawnekjxSpawnInstance PlawnekjxSpawnInstance;
typedef guint PlawnekjxDyldFlavor;
typedef struct _PlawnekjxSpawnInstanceDyldData PlawnekjxSpawnInstanceDyldData;
typedef guint PlawnekjxBreakpointPhase;
typedef guint PlawnekjxBreakpointRepeat;
typedef struct _PlawnekjxBreakpoint PlawnekjxBreakpoint;
typedef guint PlawnekjxRetState;
typedef struct _PlawnekjxPagePoolEntry PlawnekjxPagePoolEntry;
typedef struct _PlawnekjxInjectInstance PlawnekjxInjectInstance;
typedef struct _PlawnekjxInjectPayloadLayout PlawnekjxInjectPayloadLayout;
typedef struct _PlawnekjxAgentDetails PlawnekjxAgentDetails;
typedef struct _PlawnekjxAgentContext PlawnekjxAgentContext;
typedef struct _PlawnekjxAgentEmitContext PlawnekjxAgentEmitContext;

typedef struct _PlawnekjxExceptionPortSet PlawnekjxExceptionPortSet;
typedef union _PlawnekjxDebugState PlawnekjxDebugState;
typedef int PlawnekjxConvertThreadStateDirection;
typedef guint PlawnekjxAslr;

struct _PlawnekjxDispatchContext
{
  dispatch_queue_t dispatch_queue;
};

struct _PlawnekjxExceptionPortSet
{
...
enum _PlawnekjxBreakpointRepeat
{
  PLAWNEKJX_BREAKPOINT_REPEAT_NEVER,
  PLAWNEKJX_BREAKPOINT_REPEAT_ONCE,
  PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS
};

struct _PlawnekjxBreakpoint
{
  GumAddress address;
  PlawnekjxBreakpointRepeat repeat;
  guint32 original;
};

struct _PlawnekjxPagePoolEntry
{
...
{
  PlawnekjxDarwinHelperBackend * backend;
  guint pid;
  GumCpuType cpu_type;
  mach_port_t thread;
  PlawnekjxDebugState previous_debug_state;
  PlawnekjxDebugState breakpoint_debug_state;

  mach_port_t server_port;
  dispatch_source_t server_recv_source;
  PlawnekjxExceptionPortSet previous_ports;

  __Request__exception_raise_state_identity_t pending_request;

  GumDarwinModule * dyld;
  size_t dyld_size;
  PlawnekjxDyldFlavor dyld_flavor;

  PlawnekjxBreakpointPhase breakpoint_phase;
  PlawnekjxBreakpoint breakpoints[PLAWNEKJX_MAX_BREAKPOINTS];
  PlawnekjxPagePoolEntry page_pool[PLAWNEKJX_MAX_PAGE_POOL];
...
enum _PlawnekjxDyldFlavor
{
  PLAWNEKJX_DYLD_V4_PLUS,
  PLAWNEKJX_DYLD_V3_MINUS,
};

enum _PlawnekjxBreakpointPhase
{
  PLAWNEKJX_BREAKPOINT_DETECT_FLAVOR,

  /* V4+ */
  PLAWNEKJX_BREAKPOINT_SET_LIBDYLD_INITIALIZE_CALLER_BREAKPOINT,
  PLAWNEKJX_BREAKPOINT_LIBSYSTEM_INITIALIZED,

  /* V3- */
  PLAWNEKJX_BREAKPOINT_SET_HELPERS,
  PLAWNEKJX_BREAKPOINT_DLOPEN_LIBC,
  PLAWNEKJX_BREAKPOINT_SKIP_CLEAR,
  PLAWNEKJX_BREAKPOINT_DLOPEN_BOOTSTRAPPER,

  /* Common */
  PLAWNEKJX_BREAKPOINT_CF_INITIALIZE,
  PLAWNEKJX_BREAKPOINT_CLEANUP,
  PLAWNEKJX_BREAKPOINT_DONE
};

enum _PlawnekjxRetState
{
  PLAWNEKJX_RET_FROM_HELPER,
};

struct _PlawnekjxSpawnInstanceDyldData
{
  gchar libc[32];
  guint8 helpers[32];
...
struct _PlawnekjxInjectInstance
{
  ...
  PlawnekjxAgentContext * agent_context;
...
struct _PlawnekjxInjectPayloadLayout
{
...
struct _PlawnekjxAgentEmitContext
{
  guint8 * code;
#ifdef HAVE_I386
  GumX86Writer cw;
...
enum _PlawnekjxConvertThreadStateDirection
{
  PLAWNEKJX_CONVERT_THREAD_STATE_IN = 1,
  PLAWNEKJX_CONVERT_THREAD_STATE_OUT
};

enum _PlawnekjxAslr
{
  PLAWNEKJX_ASLR_AUTO,
  PLAWNEKJX_ASLR_DISABLE
};

static PlawnekjxSpawnInstance * plawnekjx_spawn_instance_new (PlawnekjxDarwinHelperBackend * backend);
static void plawnekjx_spawn_instance_close (PlawnekjxSpawnInstance * instance);
static void plawnekjx_spawn_instance_resume (PlawnekjxSpawnInstance * self);

static void plawnekjx_spawn_instance_on_server_cancel (void * context);
static void plawnekjx_spawn_instance_on_server_recv (void * context);
static gboolean plawnekjx_spawn_instance_handle_breakpoint (PlawnekjxSpawnInstance * self, PlawnekjxBreakpoint * breakpoint, GumDarwinUnifiedThreadState * state);
static gboolean plawnekjx_spawn_instance_handle_dyld_restart (PlawnekjxSpawnInstance * self);
static gboolean plawnekjx_spawn_instance_handle_modinit (PlawnekjxSpawnInstance * self, GumDarwinUnifiedThreadState * state, GumAddress pc);
static void plawnekjx_spawn_instance_receive_breakpoint_request (PlawnekjxSpawnInstance * self);
static void plawnekjx_spawn_instance_send_breakpoint_response (PlawnekjxSpawnInstance * self);
static gboolean plawnekjx_spawn_instance_is_libc_initialized (PlawnekjxSpawnInstance * self);
static void plawnekjx_spawn_instance_set_libc_initialized (PlawnekjxSpawnInstance * self);
static kern_return_t plawnekjx_spawn_instance_create_dyld_data (PlawnekjxSpawnInstance * self);
static void plawnekjx_spawn_instance_destroy_dyld_data (PlawnekjxSpawnInstance * self);
#if defined (HAVE_IOS) || defined (HAVE_TVOS) || defined (HAVE_XROS)
static gboolean plawnekjx_pick_ios_tvos_bootstrapper (GumModule * module, gpointer user_data);
#endif
static void plawnekjx_spawn_instance_unset_helpers (PlawnekjxSpawnInstance * self);
static void plawnekjx_spawn_instance_call_set_helpers (PlawnekjxSpawnInstance * self, GumDarwinUnifiedThreadState * state, mach_vm_address_t helpers);
static void plawnekjx_spawn_instance_call_dlopen (PlawnekjxSpawnInstance * self, GumDarwinUnifiedThreadState * state, mach_vm_address_t lib_name, int mode);
static gboolean plawnekjx_find_cf_initialize (GumModule * module, gpointer user_data);
static void plawnekjx_spawn_instance_call_cf_initialize (PlawnekjxSpawnInstance * self, GumDarwinUnifiedThreadState * state);
static void plawnekjx_spawn_instance_set_nth_breakpoint (PlawnekjxSpawnInstance * self, guint n, GumAddress break_at, PlawnekjxBreakpointRepeat repeat);
static void plawnekjx_spawn_instance_enable_nth_breakpoint (PlawnekjxSpawnInstance * self, guint n);
static void plawnekjx_spawn_instance_unset_nth_breakpoint (PlawnekjxSpawnInstance * self, guint n);
static void plawnekjx_spawn_instance_disable_nth_breakpoint (PlawnekjxSpawnInstance * self, guint n);
static guint32 plawnekjx_spawn_instance_put_software_breakpoint (PlawnekjxSpawnInstance * self, GumAddress where, guint index);
static guint32 plawnekjx_spawn_instance_overwrite_arm64_instruction (PlawnekjxSpawnInstance * self, GumAddress address, guint32 new_instruction);

static PlawnekjxInjectInstance * plawnekjx_inject_instance_new (PlawnekjxDarwinHelperBackend * backend, guint id, guint pid);
static PlawnekjxInjectInstance * plawnekjx_inject_instance_clone (const PlawnekjxInjectInstance * instance, guint id);
static void plawnekjx_inject_instance_close (PlawnekjxInjectInstance * instance);
static gboolean plawnekjx_inject_instance_task_did_not_exec (PlawnekjxInjectInstance * instance);

static gboolean plawnekjx_inject_instance_start_thread (PlawnekjxInjectInstance * self, GError ** error);
static void plawnekjx_inject_instance_on_thread_monitor_cancel (void * context);
static void plawnekjx_inject_instance_on_mach_thread_dead (void * context);
static void plawnekjx_inject_instance_join_posix_thread (PlawnekjxInjectInstance * self, mach_port_t posix_thread);
static void plawnekjx_inject_instance_on_posix_thread_dead (void * context);

static gboolean plawnekjx_agent_context_init (PlawnekjxAgentContext * self, const PlawnekjxAgentDetails * details, const PlawnekjxInjectPayloadLayout * layout,
...
static gboolean plawnekjx_agent_context_init_functions (PlawnekjxAgentContext * self, GumDarwinModuleResolver * resolver, GumDarwinMapper * mapper,
    GError ** error);

static void plawnekjx_agent_context_emit_mach_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper);
static void plawnekjx_agent_context_emit_pthread_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper);

static gboolean plawnekjx_convert_thread_state_for_task (mach_port_t task, thread_state_flavor_t flavor, gconstpointer in_state,
    mach_msg_type_number_t in_state_count, gpointer out_state, mach_msg_type_number_t * out_state_count, GError ** error);
static mach_port_t plawnekjx_obtain_thread_port_for_thread_id (mach_port_t task, uint64_t thread_id);
static kern_return_t plawnekjx_get_thread_state (mach_port_t thread, thread_state_flavor_t flavor, gpointer state,
    mach_msg_type_number_t * count);
static kern_return_t plawnekjx_set_thread_state (mach_port_t thread, thread_state_flavor_t flavor, gconstpointer state,
    mach_msg_type_number_t count);
static kern_return_t plawnekjx_get_debug_state (mach_port_t thread, gpointer state, GumCpuType cpu_type);
static kern_return_t plawnekjx_set_debug_state (mach_port_t thread, gconstpointer state, GumCpuType cpu_type);
static kern_return_t plawnekjx_convert_thread_state_inplace (mach_port_t thread, PlawnekjxConvertThreadStateDirection direction,
    thread_state_flavor_t flavor, gpointer state, mach_msg_type_number_t * count);
static kern_return_t plawnekjx_convert_thread_state (mach_port_t thread, PlawnekjxConvertThreadStateDirection direction,
...
static void plawnekjx_set_nth_hardware_breakpoint (gpointer state, guint n, GumAddress break_at, GumCpuType cpu_type);
static void plawnekjx_set_hardware_single_step (gpointer debug_state, GumDarwinUnifiedThreadState * thread_state, gboolean enabled, GumCpuType cpu_type);
static gboolean plawnekjx_is_hardware_breakpoint_support_working (void);

static GumAddress plawnekjx_find_run_initializers_call (mach_port_t task, GumCpuType cpu_type, GumAddress start);
static GHashTable * plawnekjx_find_modinit_strcmp_checks (mach_port_t task, GumDarwinModule * dyld);
static GumAddress plawnekjx_find_function_end (mach_port_t task, GumCpuType cpu_type, GumAddress start, gsize max_size);
static csh plawnekjx_create_capstone (GumCpuType cpu_type, GumAddress start);

static gboolean plawnekjx_parse_aslr_option (GVariant * value, PlawnekjxAslr * aslr, GError ** error);

static void plawnekjx_mapper_library_blob_deallocate (PlawnekjxMappedLibraryBlob * self);

extern int fileport_makeport (int fd, mach_port_t * port);
extern int proc_pidpath (int pid, void * buffer, uint32_t buffer_size);

void
plawnekjx_darwin_helper_backend_make_pipe_endpoints (guint local_task, guint remote_pid, guint remote_task, PlawnekjxPipeEndpoints * result, GError ** error)
{
  ...
  for (i = 0; i != G_N_ELEMENTS (sockets); i++)
  {
    ...
    plawnekjx_unix_socket_tune_buffer_sizes (fd);
  }
  ...
  plawnekjx_pipe_endpoints_init (result, local_address, remote_address);
...
void
plawnekjx_darwin_helper_backend_make_pipe_endpoint_from_socket (guint pid, guint task, GSocket * sock, gchar ** address, GError ** error)
{
  mach_port_t self_task;
  int status;
...
guint
plawnekjx_darwin_helper_backend_task_for_pid (guint pid, GError ** error)
{
...
invalid_pid:
  {
    g_set_error (error,
        PLAWNEKJX_ERROR,
        PLAWNEKJX_ERROR_PROCESS_NOT_FOUND,
...
void
plawnekjx_darwin_helper_backend_deallocate_port (guint port)
{
  mach_port_deallocate (mach_task_self (), port);
}

gboolean
plawnekjx_darwin_helper_backend_is_mmap_available (void)
{
#ifdef HAVE_MAPPER
  return TRUE;
#else
...
void
plawnekjx_darwin_helper_backend_mmap (guint task, GBytes * blob, PlawnekjxMappedLibraryBlob * result, GError ** error)
{
  gconstpointer data;
  ...
  plawnekjx_mapped_library_blob_init (result, mapped_address, size, aligned_size);
...
void
_plawnekjx_darwin_helper_backend_create_dispatch_context (PlawnekjxDarwinHelperBackend * self)
{
  PlawnekjxDispatchContext * ctx;

  ctx = g_slice_new (PlawnekjxDispatchContext);
  ctx->dispatch_queue = dispatch_queue_create ("re.plawnekjx.helper.queue", DISPATCH_QUEUE_SERIAL);

  self->dispatch_context = ctx;
}

void
_plawnekjx_darwin_helper_backend_destroy_dispatch_context (PlawnekjxDarwinHelperBackend * self)
{
  PlawnekjxDispatchContext * ctx = self->dispatch_context;

  dispatch_release (ctx->dispatch_queue);

  g_slice_free (PlawnekjxDispatchContext, ctx);
}

void
_plawnekjx_darwin_helper_backend_schedule_on_dispatch_queue (PlawnekjxDarwinHelperBackend * self, PlawnekjxDarwinHelperBackendDispatchWorker worker, gpointer user_data)
{
  PlawnekjxDispatchContext * ctx = self->dispatch_context;
...
guint
_plawnekjx_darwin_helper_backend_spawn (PlawnekjxDarwinHelperBackend * self, const gchar * path,
    PlawnekjxHostSpawnOptions * options, PlawnekjxStdioPipes ** pipes, GError ** error)
{
  pid_t pid;
  ...
  PlawnekjxAslr aslr = PLAWNEKJX_ASLR_AUTO;
  GVariant * aslr_value;
  gchar * old_cwd = NULL;
  ...
  *pipes = plawnekjx_make_stdio_pipes (options->stdio, TRUE, &in_fd, NULL, &out_fd, NULL, &err_fd, NULL, &stdio_error);
  ...
  if (aslr_value != NULL && !plawnekjx_parse_aslr_option (aslr_value, &aslr, error))
    goto early_failure;
  if (aslr == PLAWNEKJX_ASLR_DISABLE)
...
spawn_failed:
  {
    if (spawn_errno == EAGAIN)
    {
      g_set_error (error,
          PLAWNEKJX_ERROR,
          PLAWNEKJX_ERROR_EXECUTABLE_NOT_SUPPORTED,
...
any_failure:
  {
    ...
    plawnekjx_spawn_instance_close (instance);
...
gchar *
plawnekjx_darwin_helper_backend_path_for_pid (guint pid, GError ** error)
{
...
static void plawnekjx_darwin_helper_backend_launch_using_fbs (NSString * identifier, NSURL * url, PlawnekjxHostSpawnOptions * spawn_options,
    PlawnekjxDarwinHelperBackendLaunchCompletionHandler on_complete, void * on_complete_target);
static void plawnekjx_darwin_helper_backend_launch_using_sbs (NSString * identifier, NSURL * url, PlawnekjxHostSpawnOptions * spawn_options,
    PlawnekjxDarwinHelperBackendLaunchCompletionHandler on_complete, void * on_complete_target);
#ifdef HAVE_TVOS
static void plawnekjx_darwin_helper_backend_launch_using_lsaw (NSString * identifier, NSURL * url, PlawnekjxHostSpawnOptions * spawn_options,
    PlawnekjxDarwinHelperBackendLaunchCompletionHandler on_complete, void * on_complete_target);
#endif

static guint plawnekjx_kill_application (NSString * identifier);
static gboolean plawnekjx_has_active_prewarm (gint pid);
static guint8 * plawnekjx_skip_string (guint8 * cursor, guint8 * end);

static NSArray * plawnekjx_argv_to_arguments_array (gchar * const * argv, gint argv_length);
static NSDictionary * plawnekjx_envp_to_environment_dictionary (gchar * const * envp, gint envp_length);

static gboolean plawnekjx_find_uikit (const GumDependencyDetails * details, gboolean * has_uikit);

void
_plawnekjx_darwin_helper_backend_launch (const gchar * identifier, PlawnekjxHostSpawnOptions * options,
    PlawnekjxDarwinHelperBackendLaunchCompletionHandler on_complete, void * on_complete_target)
{
...
#ifdef HAVE_TVOS
  plawnekjx_darwin_helper_backend_launch_using_lsaw (identifier_value, url_value, options, on_complete, on_complete_target);
  goto beach;
#endif

  if (_plawnekjx_get_springboard_api ()->fbs != NULL)
  {
    plawnekjx_darwin_helper_backend_launch_using_fbs (identifier_value, url_value, options, on_complete, on_complete_target);
  }
  else
  {
    plawnekjx_darwin_helper_backend_launch_using_sbs (identifier_value, url_value, options, on_complete, on_complete_target);
  }
...
static void
plawnekjx_darwin_helper_backend_launch_using_fbs (NSString * identifier, NSURL * url, PlawnekjxHostSpawnOptions * spawn_options,
    PlawnekjxDarwinHelperBackendLaunchCompletionHandler on_complete, void * on_complete_target)
{
  PlawnekjxSpringboardApi * api;
  NSMutableDictionary * debug_options, * open_options;
  PlawnekjxStdioPipes * pipes = NULL;
  ...
  {
    [debug_options setObject:plawnekjx_argv_to_arguments_array (spawn_options->argv, spawn_options->argv_length1)
  ...
  {
    [debug_options setObject:plawnekjx_envp_to_environment_dictionary (spawn_options->env, spawn_options->env_length1)
  ...
  pipes = plawnekjx_make_stdio_pipes (spawn_options->stdio, FALSE, NULL, NULL, NULL, &stdout_name, NULL, &stderr_name, &error);
  if (error != NULL)
    goto failure;

  if (spawn_options->stdio == PLAWNEKJX_STDIO_PIPE)
  {
  ...
  {
    PlawnekjxStdioPipes * pending_pipes = pipes;
  ...
  {
    plawnekjx_kill_application (identifier);
...
static void
plawnekjx_darwin_helper_backend_launch_using_sbs (NSString * identifier, NSURL * url, PlawnekjxHostSpawnOptions * spawn_options,
    PlawnekjxDarwinHelperBackendLaunchCompletionHandler on_complete, void * on_complete_target)
{
  PlawnekjxSpringboardApi * api;
  ...
  if (spawn_options->stdio != PLAWNEKJX_STDIO_INHERIT)
...
static void
plawnekjx_darwin_helper_backend_launch_using_lsaw (NSString * identifier, NSURL * url, PlawnekjxHostSpawnOptions * spawn_options,
    PlawnekjxDarwinHelperBackendLaunchCompletionHandler on_complete, void * on_complete_target)
{
  PlawnekjxSpringboardApi * api;
  GError * error = NULL;
...
void
_plawnekjx_darwin_helper_backend_kill_process (guint pid)
{
  NSAutoreleasePool * pool;
  NSString * identifier;
  ...
  identifier = _plawnekjx_get_springboard_api ()->SBSCopyDisplayIdentifierForProcessID (pid);
  if (identifier != nil)
  {
    plawnekjx_kill_application (identifier);
...
guint
_plawnekjx_darwin_helper_backend_kill_application (const gchar * identifier)
{
  guint killed_pid;
  NSAutoreleasePool * pool;
  ...
  killed_pid = plawnekjx_kill_application ([NSString stringWithUTF8String:identifier]);
...
static guint
plawnekjx_kill_application (NSString * identifier)
{
  gint killed_pid = 0;
  PlawnekjxSpringboardApi * api;
  GTimer * timer;
  ...
  if (api->FBSSystemService != nil)
  {
    ...
    if (plawnekjx_has_active_prewarm (killed_pid))
    {
    ...
    else
    {
      [service terminateApplication:identifier
                          ...
                          andReport:NO
                    withDescription:@"killed from Plawnekjx"];
...
static gboolean
plawnekjx_has_active_prewarm (gint pid)
{
  ...
  cursor = plawnekjx_skip_string (cursor, end);
...
static guint8 *
plawnekjx_skip_string (guint8 * cursor, guint8 * end)
{
...
static NSArray *
plawnekjx_argv_to_arguments_array (gchar * const * argv, gint argv_length)
{
...
gboolean
plawnekjx_darwin_helper_backend_is_application_process (guint pid)
{
  gboolean is_app;
  gchar path[PROC_PIDPATHINFO_MAXSIZE];
  ...
  is_app = FALSE;
  gum_darwin_module_enumerate_dependencies (module, (GumFoundDependencyFunc) plawnekjx_find_uikit, &is_app);
...
static gboolean
plawnekjx_find_uikit (const GumDependencyDetails * details, gboolean * has_uikit)
{
...
gboolean
_plawnekjx_darwin_helper_backend_is_suspended (guint task, GError ** error)
{
...
void
plawnekjx_darwin_helper_backend_resume_process (guint task, GError ** error)
{
  mach_task_basic_info_data_t info;
  mach_msg_type_number_t info_count = MACH_TASK_BASIC_INFO_COUNT;
...
void
plawnekjx_darwin_helper_backend_resume_process_fast (guint task, GError ** error)
{
  kern_return_t kr;
...
void *
_plawnekjx_darwin_helper_backend_create_spawn_instance (PlawnekjxDarwinHelperBackend * self, guint pid)
{
  PlawnekjxSpawnInstance * instance;
...
void
_plawnekjx_darwin_helper_backend_prepare_spawn_instance_for_injection (PlawnekjxDarwinHelperBackend * self, void * opaque_instance, guint task, GError ** error)
{
  PlawnekjxSpawnInstance * instance = opaque_instance;
  PlawnekjxDispatchContext * ctx = self->dispatch_context;
  const gchar * failed_operation;
  kern_return_t kr;
   ...
   * initialized, so we won't be able to inject plawnekjx-agent at this point.
   *
   ...
   *   sufficiently initialized to load plawnekjx-agent, but still early enough so the app's
   ...
   *               support for. Search for “PLAWNEKJX_DYLD_V4_PLUS” for more details.
   *
  ...
  kr = plawnekjx_get_thread_state (child_thread, state_flavor, &state, &state_count);
  ...
  instance->dyld_flavor = (modern_entry_address != 0) ? PLAWNEKJX_DYLD_V4_PLUS : PLAWNEKJX_DYLD_V3_MINUS;
  if (instance->dyld_flavor == PLAWNEKJX_DYLD_V4_PLUS)
  {
  ...
  else
  {
    ...
    {
      modern_entry_address = plawnekjx_find_run_initializers_call (task, instance->cpu_type, launch_with_closure_address);
    }
    ...
    instance->do_modinit_strcmp_checks = plawnekjx_find_modinit_strcmp_checks (task, dyld);
    ...
    instance->ret_gadget = plawnekjx_find_function_end (task, instance->cpu_type, instance->register_helpers_address, 128);
  ...
  instance->ret_state = PLAWNEKJX_RET_FROM_HELPER;

  kr = plawnekjx_get_debug_state (child_thread, &instance->previous_debug_state, instance->cpu_type);
  CHECK_MACH_RESULT (kr, ==, KERN_SUCCESS, "plawnekjx_get_debug_state");
  ...
  if (legacy_entry_address != 0)
    plawnekjx_spawn_instance_set_nth_breakpoint (instance, i++, legacy_entry_address, PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS);
  if (modern_entry_address != 0)
    plawnekjx_spawn_instance_set_nth_breakpoint (instance, i++, modern_entry_address, PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS);
  if (sim_notify_address != 0)
    plawnekjx_spawn_instance_set_nth_breakpoint (instance, i++, sim_notify_address, PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS);
  if (instance->dyld_flavor == PLAWNEKJX_DYLD_V4_PLUS)
  {
    ...
    if (restart_with_dyld_in_cache != 0)
      plawnekjx_spawn_instance_set_nth_breakpoint (instance, i++, restart_with_dyld_in_cache, PLAWNEKJX_BREAKPOINT_REPEAT_NEVER);
  }

  kr = plawnekjx_set_debug_state (child_thread, &instance->breakpoint_debug_state, instance->cpu_type);
  CHECK_MACH_RESULT (kr, ==, KERN_SUCCESS, "plawnekjx_set_debug_state");
  ...
  dispatch_source_set_cancel_handler_f (source, plawnekjx_spawn_instance_on_server_cancel);
  dispatch_source_set_event_handler_f (source, plawnekjx_spawn_instance_on_server_recv);
...
void
_plawnekjx_darwin_helper_backend_resume_spawn_instance (PlawnekjxDarwinHelperBackend * self, void * instance)
{
  plawnekjx_spawn_instance_resume (instance);
}

void
_plawnekjx_darwin_helper_backend_close_spawn_instance (PlawnekjxDarwinHelperBackend * self, void * instance)
{
  plawnekjx_spawn_instance_close (instance);
}

guint
_plawnekjx_darwin_helper_backend_inject_into_task (PlawnekjxDarwinHelperBackend * self, guint pid, guint task, const gchar * path_or_name, PlawnekjxMappedLibraryBlob * blob,
    const gchar * entrypoint, const gchar * data, GError ** error)
{
  ...
  PlawnekjxDarwinModuleDetails mapped_module;
  PlawnekjxAgentDetails details = { 0, };
  guint page_size;
  PlawnekjxInjectPayloadLayout layout;
  kern_return_t kr;
  const gchar * failed_operation;
  ...
  PlawnekjxAgentContext agent_ctx;
  GumAddress pc, sp, data_arg;

  self_task = mach_task_self ();

  instance = plawnekjx_inject_instance_new (self, self->next_id++, pid);
  mach_port_mod_refs (self_task, task, MACH_PORT_RIGHT_SEND, 1);
  instance->task = task;
  ...
  if (blob != NULL)
  {
    mapper = gum_darwin_mapper_new_take_blob (path_or_name,
        g_bytes_new_with_free_func (GSIZE_TO_POINTER (blob->address), blob->size,
            (GDestroyNotify) plawnekjx_mapper_library_blob_deallocate, plawnekjx_mapped_library_blob_dup (blob)),
        resolver, &io_error);
  }
  else
  {
  ...
  if (io_error != NULL)
    goto gum_failure;
#else
  (void) plawnekjx_mapper_library_blob_deallocate;
#endif
  ...
  layout.data_size = GUM_ALIGN_SIZE (sizeof (PlawnekjxAgentContext), page_size);
  ...
  instance->agent_context = (PlawnekjxAgentContext *) agent_context_address;
  ...
  if (!plawnekjx_agent_context_init (&agent_ctx, &details, &layout, payload_address, instance->payload_size, resolver, mapper, error))
    goto failure;

  plawnekjx_agent_context_emit_mach_stub_code (&agent_ctx, mach_stub_code, resolver, mapper);

  plawnekjx_agent_context_emit_pthread_stub_code (&agent_ctx, pthread_stub_code, resolver, mapper);
  ...
  else
  {
    ...
    state32->__pc = pc;
    state32->__cpsr = PLAWNEKJX_PSR_THUMB;
  ...
  if (!plawnekjx_inject_instance_start_thread (instance, error))
    goto failure;

  gee_abstract_map_set (GEE_ABSTRACT_MAP (self->inject_instances), GUINT_TO_POINTER (instance->id), instance);

  instance->is_loaded = TRUE;
  _plawnekjx_darwin_helper_backend_on_inject_instance_loaded (self, instance->id, instance->pid, (mapper != NULL) ? &mapped_module : NULL);
...
failure:
  {
    plawnekjx_inject_instance_close (instance);
    goto beach;
  }
beach:
  {
...
void
_plawnekjx_darwin_helper_backend_demonitor (PlawnekjxDarwinHelperBackend * self, void * raw_instance)
{
...
guint
_plawnekjx_darwin_helper_backend_demonitor_and_clone_injectee_state (PlawnekjxDarwinHelperBackend * self, void * raw_instance)
{
  PlawnekjxInjectInstance * instance = raw_instance;
  ...
  clone = plawnekjx_inject_instance_clone (instance, self->next_id++);
...
void
_plawnekjx_darwin_helper_backend_recreate_injectee_thread (PlawnekjxDarwinHelperBackend * self, void * raw_instance, guint pid, guint task, GError ** error)
{
  PlawnekjxInjectInstance * instance = raw_instance;
  PlawnekjxAgentContext * agent_context = instance->agent_context;
  mach_port_t self_task;
  gboolean is_uninitialized_clone;
  const gchar * failed_operation;
  kern_return_t kr;

  agent_context->unload_policy = PLAWNEKJX_UNLOAD_POLICY_IMMEDIATE;
...
failure:
  {
    _plawnekjx_darwin_helper_backend_destroy_inject_instance (self, instance->id);
    goto beach;
  }
beach:
  {
...
static gboolean
plawnekjx_inject_instance_start_thread (PlawnekjxInjectInstance * self, GError ** error)
{
  ...
  kern_return_t kr;
  const gchar * failed_operation;
  PlawnekjxDispatchContext * ctx = self->backend->dispatch_context;
  dispatch_source_t source;

  thread_state = g_alloca (self->thread_state_count * sizeof (natural_t));
  thread_state_count = self->thread_state_count;

  if (!plawnekjx_convert_thread_state_for_task (self->task, self->thread_state_flavor, self->thread_state_data, self->thread_state_count,
  ...
  dispatch_source_set_cancel_handler_f (source, plawnekjx_inject_instance_on_thread_monitor_cancel);
  dispatch_source_set_event_handler_f (source, plawnekjx_inject_instance_on_mach_thread_dead);
  dispatch_resume (source);
...
static void
plawnekjx_inject_instance_on_thread_monitor_cancel (void * context)
{
  PlawnekjxInjectInstance * self = context;

  dispatch_release (g_steal_pointer (&self->thread_monitor_source));
  plawnekjx_inject_instance_close (self);
}

static void
plawnekjx_inject_instance_on_mach_thread_dead (void * context)
{
  PlawnekjxInjectInstance * self = context;
  ...
  if (posix_thread_right_in_remote_task != MACH_PORT_NULL)
  {
    ...
    {
      posix_thread_right_in_local_task = plawnekjx_obtain_thread_port_for_thread_id (self->task, self->agent_context->posix_tid);
  ...
  _plawnekjx_darwin_helper_backend_on_mach_thread_dead (self->backend, self->id, GSIZE_TO_POINTER (posix_thread_right_in_local_task));
}

void
_plawnekjx_darwin_helper_backend_join_inject_instance_posix_thread (PlawnekjxDarwinHelperBackend * self, void * instance, void * posix_thread)
{
  plawnekjx_inject_instance_join_posix_thread (instance, GPOINTER_TO_SIZE (posix_thread));
}

static void
plawnekjx_inject_instance_join_posix_thread (PlawnekjxInjectInstance * self, mach_port_t posix_thread)
{
  PlawnekjxDispatchContext * ctx = self->backend->dispatch_context;
  mach_port_t self_task;
  dispatch_source_t source;
  ...
  dispatch_set_context (source, self);
  dispatch_source_set_cancel_handler_f (source, plawnekjx_inject_instance_on_thread_monitor_cancel);
  dispatch_source_set_event_handler_f (source, plawnekjx_inject_instance_on_posix_thread_dead);
  dispatch_resume (source);
}

static void
plawnekjx_inject_instance_on_posix_thread_dead (void * context)
{
  PlawnekjxInjectInstance * self = context;

  _plawnekjx_darwin_helper_backend_on_posix_thread_dead (self->backend, self->id);
}

guint
_plawnekjx_darwin_helper_backend_get_pid_of_inject_instance (PlawnekjxDarwinHelperBackend * self, void * instance)
{
  return ((PlawnekjxInjectInstance *) instance)->pid;
}

void
_plawnekjx_darwin_helper_backend_close_inject_instance (PlawnekjxDarwinHelperBackend * self, void * instance)
{
  plawnekjx_inject_instance_close (instance);
}

static PlawnekjxSpawnInstance *
plawnekjx_spawn_instance_new (PlawnekjxDarwinHelperBackend * backend)
{
  PlawnekjxSpawnInstance * instance;
  guint i;
  ...
  instance->breakpoint_phase = PLAWNEKJX_BREAKPOINT_DETECT_FLAVOR;
  instance->single_stepping = -1;
  for (i = 0; i != PLAWNEKJX_MAX_BREAKPOINTS; i++)
  {
    instance->breakpoints[i].address = 0;
    instance->breakpoints[i].repeat = PLAWNEKJX_BREAKPOINT_REPEAT_NEVER;
  }

  for (i = 0; i != PLAWNEKJX_MAX_PAGE_POOL; i++)
  {
    instance->page_pool[i].page_start = 0;
    instance->page_pool[i].scratch_page = 0;
  }

  _plawnekjx_darwin_helper_backend_on_instance_created (backend, instance);

  return instance;
}

static void
plawnekjx_spawn_instance_close (PlawnekjxSpawnInstance * instance)
{
  task_t self_task;
  PlawnekjxExceptionPortSet * previous_ports;
  ...
  _plawnekjx_darwin_helper_backend_on_instance_destroyed (instance->backend, instance);
...
static GumAddress
plawnekjx_spawn_instance_get_ret_gadget_address (PlawnekjxSpawnInstance * self)
{
...
{
  if (self->breakpoint_phase != PLAWNEKJX_BREAKPOINT_DONE)
  {
    guint task;
    GError * error = NULL;

    task = plawnekjx_darwin_helper_backend_task_for_pid (self->pid, &error);
    if (error == NULL)
    {
      plawnekjx_darwin_helper_backend_resume_process (task, &error);
  ...
  plawnekjx_spawn_instance_send_breakpoint_response (self);
}

static void
plawnekjx_spawn_instance_on_server_cancel (void * context)
{
  PlawnekjxSpawnInstance * self = context;

  dispatch_release (g_steal_pointer (&self->server_recv_source));
  plawnekjx_spawn_instance_close (self);
}

static void
plawnekjx_spawn_instance_on_server_recv (void * context)
{
  PlawnekjxSpawnInstance * self = context;
  ...
  PlawnekjxBreakpoint * breakpoint = NULL;
  gboolean carry_on, pc_changed;

  plawnekjx_spawn_instance_receive_breakpoint_request (self);
  ...
  kr = plawnekjx_get_thread_state (self->thread, state_flavor, &state, &state_count);
  if (kr != KERN_SUCCESS)
    return;

#if __has_feature (ptrauth_calls)
  {
    const GumAddress ret_gadget = plawnekjx_spawn_instance_get_ret_gadget_address (self);
  ...
  {
    PlawnekjxBreakpoint * bp = &self->breakpoints[self->single_stepping];

    plawnekjx_set_hardware_single_step (&self->breakpoint_debug_state, &state, FALSE, self->cpu_type);

    if (bp->repeat != PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS)
      plawnekjx_spawn_instance_unset_nth_breakpoint (self, self->single_stepping);
    self->single_stepping = -1;

    for (i = 0; i != PLAWNEKJX_MAX_BREAKPOINTS; i++)
    {
      PlawnekjxBreakpoint * bp = &self->breakpoints[i];
      if (bp->repeat != PLAWNEKJX_BREAKPOINT_REPEAT_NEVER)
        plawnekjx_spawn_instance_set_nth_breakpoint (self, i, bp->address, bp->repeat);
    }

    plawnekjx_set_thread_state (self->thread, state_flavor, &state, state_count);
    plawnekjx_set_debug_state (self->thread, &self->breakpoint_debug_state, self->cpu_type);
  ...
  carry_on = plawnekjx_spawn_instance_handle_breakpoint (self, breakpoint, &state);
  if (!carry_on)
    return;
  ...
  {
    for (i = 0; i != PLAWNEKJX_MAX_BREAKPOINTS; i++)
      plawnekjx_spawn_instance_disable_nth_breakpoint (self, i);

    plawnekjx_set_hardware_single_step (&self->breakpoint_debug_state, &state, TRUE, self->cpu_type);

    self->single_stepping = current_bp_index;
  }
  else if (breakpoint->repeat != PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS)
  {
    plawnekjx_spawn_instance_unset_nth_breakpoint (self, current_bp_index);
  }
...
unexpected_exception:
  {
    ...
    error = g_error_new_literal (PLAWNEKJX_ERROR, PLAWNEKJX_ERROR_NOT_SUPPORTED, message->str);

    _plawnekjx_darwin_helper_backend_on_spawn_instance_error (self->backend, self->pid, error);
...
static gboolean
plawnekjx_spawn_instance_handle_breakpoint (PlawnekjxSpawnInstance * self, PlawnekjxBreakpoint * breakpoint, GumDarwinUnifiedThreadState * state)
{
  kern_return_t kr;
  GumAddress pc;
  thread_state_flavor_t state_flavor = GUM_DARWIN_THREAD_STATE_FLAVOR;
  ...
  if (self->breakpoint_phase == PLAWNEKJX_BREAKPOINT_DETECT_FLAVOR)
  {
    if (pc == self->sim_notify_address)
    {
      self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_LIBSYSTEM_INITIALIZED;
    }
    else if (self->dyld_flavor == PLAWNEKJX_DYLD_V4_PLUS)
    {
      ...
      {
        return plawnekjx_spawn_instance_handle_dyld_restart (self);
      }
    }
    else
    {
      ...
      if (pc == self->modern_entry_address)
        self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_CF_INITIALIZE;
      else
        self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_SET_HELPERS;
    }
  }

  if (pc == plawnekjx_spawn_instance_get_ret_gadget_address (self))
  {
#ifdef HAVE_I386
    if (self->ret_state == PLAWNEKJX_RET_FROM_HELPER)
    {
      if (self->cpu_type == GUM_CPU_AMD64)
    ...
    self->ret_state = PLAWNEKJX_RET_FROM_HELPER;

    return TRUE;
  }

  if (plawnekjx_spawn_instance_handle_modinit (self, state, pc))
    return TRUE;

next_phase:
  switch (self->breakpoint_phase)
  {
    case PLAWNEKJX_BREAKPOINT_SET_LIBDYLD_INITIALIZE_CALLER_BREAKPOINT:
    {
      ...
      plawnekjx_spawn_instance_set_nth_breakpoint (self, 1, libsystem_initializer_caller, PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS);
    ...
    case PLAWNEKJX_BREAKPOINT_LIBSYSTEM_INITIALIZED:
      memcpy (&self->previous_thread_state, state, sizeof (GumDarwinUnifiedThreadState));
      self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_CF_INITIALIZE;
      goto next_phase;

    case PLAWNEKJX_BREAKPOINT_SET_HELPERS:
      plawnekjx_spawn_instance_create_dyld_data (self);

      plawnekjx_spawn_instance_call_set_helpers (self, state, self->fake_helpers);

      plawnekjx_spawn_instance_set_nth_breakpoint (self, 2, self->ret_gadget, PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS);

      self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_DLOPEN_LIBC;

      return TRUE;

    case PLAWNEKJX_BREAKPOINT_DLOPEN_LIBC:
      if (plawnekjx_spawn_instance_is_libc_initialized (self))
      {
        plawnekjx_spawn_instance_unset_helpers (self);
      }
      else
      {
        GHashTableIter iter;
        ...
        while (g_hash_table_iter_next (&iter, &strcmp_check, NULL))
        {
          ...
          plawnekjx_spawn_instance_set_nth_breakpoint (self, breakpoint_index, GUM_ADDRESS (strcmp_check), PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS);
          breakpoint_index++;
        }
      }
      ...
      plawnekjx_spawn_instance_call_dlopen (self, state, self->lib_name, RTLD_GLOBAL | RTLD_LAZY);

      if (self->dlerror_clear_address != 0)
      {
        plawnekjx_spawn_instance_set_nth_breakpoint (self, 3, self->dlerror_clear_address, PLAWNEKJX_BREAKPOINT_REPEAT_ONCE);
        self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_SKIP_CLEAR;
      }
      else
      {
        self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_DLOPEN_BOOTSTRAPPER;
      }

      return TRUE;

    case PLAWNEKJX_BREAKPOINT_SKIP_CLEAR:
#ifdef HAVE_I386
      if (self->cpu_type == GUM_CPU_AMD64)
    ...
    case PLAWNEKJX_BREAKPOINT_DLOPEN_BOOTSTRAPPER:
#if defined (HAVE_IOS) || defined (HAVE_TVOS) || defined (HAVE_XROS)
      if (self->bootstrapper_name != 0)
      {
        plawnekjx_spawn_instance_set_libc_initialized (self);
        plawnekjx_spawn_instance_unset_nth_breakpoint (self, 1);
        memcpy (state, &self->previous_thread_state, sizeof (GumDarwinUnifiedThreadState));

        plawnekjx_spawn_instance_call_dlopen (self, state, self->bootstrapper_name, RTLD_GLOBAL | RTLD_LAZY);

        self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_CLEANUP;

        return TRUE;
      }
#endif

    case PLAWNEKJX_BREAKPOINT_CF_INITIALIZE:
      gum_darwin_enumerate_modules (self->task, plawnekjx_find_cf_initialize, self);

      if (self->cf_initialize_address != 0)
      {
        memcpy (state, &self->previous_thread_state, sizeof (GumDarwinUnifiedThreadState));

        if (self->dyld_flavor == PLAWNEKJX_DYLD_V3_MINUS && pc != self->modern_entry_address)
          plawnekjx_spawn_instance_unset_nth_breakpoint (self, 1);

        plawnekjx_spawn_instance_call_cf_initialize (self, state);
    ...
    case PLAWNEKJX_BREAKPOINT_CLEANUP:
    {
      task_t self_task;
      gsize page_size;
      PlawnekjxExceptionPortSet * previous_ports;
      ...
      kr = plawnekjx_set_thread_state (self->thread, state_flavor, &self->previous_thread_state, state_count);
      if (kr != KERN_SUCCESS)
        return FALSE;

      plawnekjx_spawn_instance_destroy_dyld_data (self);

      for (i = 0; i != PLAWNEKJX_MAX_BREAKPOINTS; i++)
        plawnekjx_spawn_instance_unset_nth_breakpoint (self, i);
      ...
      plawnekjx_set_debug_state (self->thread, &self->previous_debug_state, self->cpu_type);

      if (self->info_address != 0)
        plawnekjx_spawn_instance_set_libc_initialized (self);

      self->breakpoint_phase = PLAWNEKJX_BREAKPOINT_DONE;

      _plawnekjx_darwin_helper_backend_on_spawn_instance_ready (self->backend, self->pid);
...
static gboolean
plawnekjx_spawn_instance_handle_dyld_restart (PlawnekjxSpawnInstance * self)
{
  ...
  plawnekjx_spawn_instance_set_nth_breakpoint (self, 0, self->modern_entry_address, PLAWNEKJX_BREAKPOINT_REPEAT_ALWAYS);
...
static gboolean
plawnekjx_spawn_instance_handle_modinit (PlawnekjxSpawnInstance * self, GumDarwinUnifiedThreadState * state, GumAddress pc)
{
...
static void
plawnekjx_spawn_instance_receive_breakpoint_request (PlawnekjxSpawnInstance * self)
{
  __Request__exception_raise_state_identity_t * request = &self->pending_request;
...
static void
plawnekjx_spawn_instance_send_breakpoint_response (PlawnekjxSpawnInstance * self)
{
  __Request__exception_raise_state_identity_t * request = &self->pending_request;
...
static gboolean
plawnekjx_spawn_instance_is_libc_initialized (PlawnekjxSpawnInstance * self)
{
...
static void
plawnekjx_spawn_instance_set_libc_initialized (PlawnekjxSpawnInstance * self)
{
  GumAddress initialized_address;
...
plawnekjx_spawn_instance_create_dyld_data (PlawnekjxSpawnInstance * self)
{
  GumPtrauthSupport ptrauth_support;
  GumAddress ret_gadget;
  PlawnekjxSpawnInstanceDyldData data = { "/usr/lib/libSystem.B.dylib", { 0, }, "", { 0, } };
  kern_return_t kr;
  gboolean write_succeeded;
...
#if defined (HAVE_IOS) || defined (HAVE_TVOS) || defined (HAVE_XROS)
  gum_darwin_enumerate_modules (self->task, plawnekjx_pick_ios_tvos_bootstrapper, &data);
#endif
  ...
  self->fake_helpers = self->dyld_data + offsetof (PlawnekjxSpawnInstanceDyldData, helpers);
  self->lib_name = self->dyld_data + offsetof (PlawnekjxSpawnInstanceDyldData, libc);
  if (data.bootstrapper[0] == '\0')
    self->bootstrapper_name = 0;
  else
    self->bootstrapper_name = self->dyld_data + offsetof (PlawnekjxSpawnInstanceDyldData, bootstrapper);
  self->fake_error_buf = self->dyld_data + offsetof (PlawnekjxSpawnInstanceDyldData, error_buf);

  return KERN_SUCCESS;
}

static void
plawnekjx_spawn_instance_destroy_dyld_data (PlawnekjxSpawnInstance * self)
{
  if (self->dyld_data == 0)
    return;

  vm_deallocate (self->task, (vm_address_t) self->dyld_data, sizeof (PlawnekjxSpawnInstanceDyldData));
...
static gboolean
plawnekjx_pick_ios_tvos_bootstrapper (GumModule * module, gpointer user_data)
{
  PlawnekjxSpawnInstanceDyldData * data = user_data;
  const gchar * path;
...
static void
plawnekjx_spawn_instance_unset_helpers (PlawnekjxSpawnInstance * self)
{
  gboolean write_succeeded;
...
static void
plawnekjx_spawn_instance_call_set_helpers (PlawnekjxSpawnInstance * self, GumDarwinUnifiedThreadState * state, mach_vm_address_t helpers)
{
...
static void
plawnekjx_spawn_instance_call_dlopen (PlawnekjxSpawnInstance * self, GumDarwinUnifiedThreadState * state, mach_vm_address_t lib_name, int mode)
{
  GumAddress new_pc, current_pc;
...
static gboolean
plawnekjx_find_cf_initialize (GumModule * module, gpointer user_data)
{
  PlawnekjxSpawnInstance * self = user_data;
...
static void
plawnekjx_spawn_instance_call_cf_initialize (PlawnekjxSpawnInstance * self, GumDarwinUnifiedThreadState * state)
{
  GumAddress new_pc, current_pc;
...
static void
plawnekjx_spawn_instance_set_nth_breakpoint (PlawnekjxSpawnInstance * self, guint n, GumAddress break_at, PlawnekjxBreakpointRepeat repeat)
{
  g_assert (n < PLAWNEKJX_MAX_BREAKPOINTS);

  if (self->breakpoints[n].address != 0 && self->breakpoints[n].address != break_at)
    plawnekjx_spawn_instance_disable_nth_breakpoint (self, n);

  self->breakpoints[n].address = break_at;
  self->breakpoints[n].repeat = repeat;

  plawnekjx_spawn_instance_enable_nth_breakpoint (self, n);
}

static void
plawnekjx_spawn_instance_enable_nth_breakpoint (PlawnekjxSpawnInstance * self, guint n)
{
  PlawnekjxBreakpoint * breakpoint;
  ...
  if (plawnekjx_is_hardware_breakpoint_support_working ())
    plawnekjx_set_nth_hardware_breakpoint (&self->breakpoint_debug_state, n, breakpoint->address, self->cpu_type);
  else
    breakpoint->original = plawnekjx_spawn_instance_put_software_breakpoint (self, breakpoint->address, n);
}

static void
plawnekjx_spawn_instance_unset_nth_breakpoint (PlawnekjxSpawnInstance * self, guint n)
{
  g_assert (n < PLAWNEKJX_MAX_BREAKPOINTS);
  ...
  self->breakpoints[n].repeat = PLAWNEKJX_BREAKPOINT_REPEAT_NEVER;
}

static void
plawnekjx_spawn_instance_disable_nth_breakpoint (PlawnekjxSpawnInstance * self, guint n)
{
  g_assert (n < PLAWNEKJX_MAX_BREAKPOINTS);

  if (plawnekjx_is_hardware_breakpoint_support_working ())
  {
    plawnekjx_set_nth_hardware_breakpoint (&self->breakpoint_debug_state, n, 0, self->cpu_type);
  }
  else
  {
    PlawnekjxBreakpoint * breakpoint = &self->breakpoints[n];

    if (breakpoint->address != 0)
      plawnekjx_spawn_instance_overwrite_arm64_instruction (self, breakpoint->address, breakpoint->original);
  }
}

static guint32
plawnekjx_spawn_instance_put_software_breakpoint (PlawnekjxSpawnInstance * self, GumAddress where, guint index)
{
  guint32 instr_data;

  g_assert (index < PLAWNEKJX_MAX_BREAKPOINTS);

  instr_data = 0xd4200000 | ((index & 0xffff) << 5);

  return plawnekjx_spawn_instance_overwrite_arm64_instruction (self, where, instr_data);
}

static guint32
plawnekjx_spawn_instance_overwrite_arm64_instruction (PlawnekjxSpawnInstance * self, GumAddress address, guint32 new_instruction)
{
...
plawnekjx_inject_instance_new (PlawnekjxDarwinHelperBackend * backend, guint id, guint pid)
{
  PlawnekjxInjectInstance * instance;

  instance = g_slice_new (PlawnekjxInjectInstance);
  instance->id = id;
...
plawnekjx_inject_instance_clone (const PlawnekjxInjectInstance * instance, guint id)
{
  ...
  clone->agent_context = (PlawnekjxAgentContext *) agent_context_address;
  ...
  _plawnekjx_darwin_helper_backend_on_instance_created (clone->backend, clone);

  return clone;
}

static void
plawnekjx_inject_instance_close (PlawnekjxInjectInstance * instance)
{
  PlawnekjxAgentContext * agent_context = instance->agent_context;
  task_t self_task;
  ...
  can_deallocate_payload = !(agent_context != NULL && agent_context->unload_policy != PLAWNEKJX_UNLOAD_POLICY_IMMEDIATE && instance->is_mapped);
  if (instance->payload_address != 0 &&
      can_deallocate_payload &&
      plawnekjx_inject_instance_task_did_not_exec (instance))
  {
    mach_vm_deallocate (instance->task, instance->payload_address, instance->payload_size);

    if (instance->is_loaded)
    {
      _plawnekjx_darwin_helper_backend_on_inject_instance_unloaded (instance->backend, instance->id, instance->pid);
    }
  }
  else
  {
    _plawnekjx_darwin_helper_backend_on_inject_instance_detached (instance->backend, instance->id, instance->pid);
  }
...
static gboolean
plawnekjx_inject_instance_task_did_not_exec (PlawnekjxInjectInstance * instance)
{
...
static gboolean
plawnekjx_agent_context_init (PlawnekjxAgentContext * self, const PlawnekjxAgentDetails * details, const PlawnekjxInjectPayloadLayout * layout,
    mach_vm_address_t payload_base, mach_vm_size_t payload_size, GumDarwinModuleResolver * resolver, GumDarwinMapper * mapper, GError ** error)
{
  bzero (self, sizeof (PlawnekjxAgentContext));

  self->unload_policy = PLAWNEKJX_UNLOAD_POLICY_IMMEDIATE;
  ...
  if (!plawnekjx_agent_context_init_functions (self, resolver, mapper, error))
    return FALSE;
  ...
  self->message_that_never_arrives = payload_base + layout->data_offset +
      G_STRUCT_OFFSET (PlawnekjxAgentContext, message_that_never_arrives_storage);
  ...
  self->dylib_path = payload_base + layout->data_offset +
      G_STRUCT_OFFSET (PlawnekjxAgentContext, dylib_path_storage);
  ...
  self->entrypoint_name = payload_base + layout->data_offset +
      G_STRUCT_OFFSET (PlawnekjxAgentContext, entrypoint_name_storage);
  strcpy (self->entrypoint_name_storage, details->entrypoint_name);

  self->entrypoint_data = payload_base + layout->data_offset +
      G_STRUCT_OFFSET (PlawnekjxAgentContext, entrypoint_data_storage);
  ...
  self->mapped_range = (mapper != NULL)
      ? payload_base + layout->data_offset + G_STRUCT_OFFSET (PlawnekjxAgentContext, mapped_range_storage)
      : 0;
...
#define PLAWNEKJX_AGENT_CONTEXT_RESOLVE(field) \
  G_STMT_START \
  { \
    PLAWNEKJX_AGENT_CONTEXT_TRY_RESOLVE (field); \
    if (self->field##_impl == 0) \
      goto missing_symbol; \
  } \
  G_STMT_END
#define PLAWNEKJX_AGENT_CONTEXT_TRY_RESOLVE(field) \
  self->field##_impl = gum_strip_code_address (gum_darwin_module_resolver_find_export_address (resolver, module, G_STRINGIFY (field)))

static gboolean
plawnekjx_agent_context_init_functions (PlawnekjxAgentContext * self, GumDarwinModuleResolver * resolver, GumDarwinMapper * mapper, GError ** error)
{
  gboolean success = FALSE;
  GumDarwinModule * module;
  ...
  if (module == NULL)
    goto no_libc;
  PLAWNEKJX_AGENT_CONTEXT_RESOLVE (mach_task_self);
  PLAWNEKJX_AGENT_CONTEXT_RESOLVE (mach_thread_self);
  PLAWNEKJX_AGENT_CONTEXT_RESOLVE (mach_port_allocate);
  PLAWNEKJX_AGENT_CONTEXT_RESOLVE (mach_msg_receive);
  PLAWNEKJX_AGENT_CONTEXT_RESOLVE (mach_port_destroy);
  PLAWNEKJX_AGENT_CONTEXT_RESOLVE (thread_terminate);
  g_object_unref (module);
  module = NULL;
  ...
  if (module == NULL)
    goto no_libc;
  PLAWNEKJX_AGENT_CONTEXT_TRY_RESOLVE (pthread_create_from_mach_thread);
  if (self->pthread_create_from_mach_thread_impl != 0)
    self->pthread_create_impl = self->pthread_create_from_mach_thread_impl;
  else
    PLAWNEKJX_AGENT_CONTEXT_RESOLVE (pthread_create);
  PLAWNEKJX_AGENT_CONTEXT_TRY_RESOLVE (pthread_threadid_np);
  PLAWNEKJX_AGENT_CONTEXT_RESOLVE (pthread_detach);
  PLAWNEKJX_AGENT_CONTEXT_RESOLVE (pthread_self);
  g_object_unref (module);
  module = NULL;
  ...
  if (mapper == NULL)
  {
    ...
    if (module == NULL)
      goto no_libc;
    PLAWNEKJX_AGENT_CONTEXT_RESOLVE (dlopen);
    PLAWNEKJX_AGENT_CONTEXT_RESOLVE (dlsym);
    PLAWNEKJX_AGENT_CONTEXT_RESOLVE (dlclose);
    g_object_unref (module);
    module = NULL;
  }
...
static void plawnekjx_agent_context_emit_mach_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx);
static void plawnekjx_agent_context_emit_pthread_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx);

static void
plawnekjx_agent_context_emit_mach_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper)
{
  PlawnekjxAgentEmitContext ctx;
  ...
  plawnekjx_agent_context_emit_mach_stub_body (self, &ctx);
...
static void
plawnekjx_agent_context_emit_pthread_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper)
{
  PlawnekjxAgentEmitContext ctx;
  guint locals_size;
  ...
  plawnekjx_agent_context_emit_pthread_stub_body (self, &ctx);
...
#define EMIT_LOAD(reg, field) \
    gum_x86_writer_put_mov_reg_reg_offset_ptr (&ctx->cw, GUM_X86_##reg, GUM_X86_XBX, G_STRUCT_OFFSET (PlawnekjxAgentContext, field))
#define EMIT_LOAD_ADDRESS_OF(reg, field) \
    gum_x86_writer_put_lea_reg_reg_offset (&ctx->cw, GUM_X86_##reg, GUM_X86_XBX, G_STRUCT_OFFSET (PlawnekjxAgentContext, field))
#define EMIT_STORE(field, reg) \
    gum_x86_writer_put_mov_reg_offset_ptr_reg (&ctx->cw, GUM_X86_XBX, G_STRUCT_OFFSET (PlawnekjxAgentContext, field), GUM_X86_##reg)
#define EMIT_CALL(fun, ...) \
    gum_x86_writer_put_call_reg_offset_ptr_with_aligned_arguments (&ctx->cw, GUM_CALL_CAPI, GUM_X86_XBX, G_STRUCT_OFFSET (PlawnekjxAgentContext, fun), __VA_ARGS__)

static void
plawnekjx_agent_context_emit_mach_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx)
{
...
static void
plawnekjx_agent_context_emit_pthread_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx)
{
  ...
  gum_x86_writer_put_mov_reg_offset_ptr_reg (&ctx->cw,
      GUM_X86_XBP, injector_state_offset + G_STRUCT_OFFSET (PlawnekjxDarwinInjectorState, mapped_range),
      GUM_X86_XDX);
  ...
  gum_x86_writer_put_cmp_reg_i32 (&ctx->cw, GUM_X86_EAX, PLAWNEKJX_UNLOAD_POLICY_IMMEDIATE);
  ...
  EMIT_LOAD (EAX, unload_policy);
  gum_x86_writer_put_cmp_reg_i32 (&ctx->cw, GUM_X86_EAX, PLAWNEKJX_UNLOAD_POLICY_DEFERRED);
...
static void plawnekjx_agent_context_emit_arm_mach_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper);
static void plawnekjx_agent_context_emit_arm_pthread_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper);
static void plawnekjx_agent_context_emit_arm_mach_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx);
static void plawnekjx_agent_context_emit_arm_pthread_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx);
static void plawnekjx_agent_context_emit_arm_load_reg_with_ctx_value (arm_reg reg, guint field_offset, GumThumbWriter * tw);
static void plawnekjx_agent_context_emit_arm_store_reg_in_ctx_value (guint field_offset, arm_reg reg, GumThumbWriter * tw);

static void plawnekjx_agent_context_emit_arm64_mach_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper);
static void plawnekjx_agent_context_emit_arm64_pthread_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper);
static void plawnekjx_agent_context_emit_arm64_mach_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx);
static void plawnekjx_agent_context_emit_arm64_pthread_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx);
    ...
    GumDarwinMapper * mapper)
{
  if (resolver->cpu_type == GUM_CPU_ARM)
    plawnekjx_agent_context_emit_arm_mach_stub_code (self, code, resolver, mapper);
  else
    plawnekjx_agent_context_emit_arm64_mach_stub_code (self, code, resolver, mapper);
}
...
{
  if (resolver->cpu_type == GUM_CPU_ARM)
    plawnekjx_agent_context_emit_arm_pthread_stub_code (self, code, resolver, mapper);
  else
    plawnekjx_agent_context_emit_arm64_pthread_stub_code (self, code, resolver, mapper);
}
...
static void
plawnekjx_agent_context_emit_arm_mach_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper)
{
  PlawnekjxAgentEmitContext ctx;
  ...
  plawnekjx_agent_context_emit_arm_mach_stub_body (self, &ctx);

  gum_thumb_writer_clear (&ctx.tw);
}

static void
plawnekjx_agent_context_emit_arm_pthread_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper)
{
  PlawnekjxAgentEmitContext ctx;
  ...
  plawnekjx_agent_context_emit_arm_pthread_stub_body (self, &ctx);
...
#define EMIT_ARM_LOAD(reg, field) \
    plawnekjx_agent_context_emit_arm_load_reg_with_ctx_value (ARM_REG_##reg, G_STRUCT_OFFSET (PlawnekjxAgentContext, field), &ctx->tw)
#define EMIT_ARM_LOAD_ADDRESS_OF(reg, field) \
    gum_thumb_writer_put_add_reg_reg_imm (&ctx->tw, ARM_REG_##reg, ARM_REG_R7, G_STRUCT_OFFSET (PlawnekjxAgentContext, field))
#define EMIT_ARM_LOAD_U32(reg, val) \
    gum_thumb_writer_put_ldr_reg_u32 (&ctx->tw, ARM_REG_##reg, val)
#define EMIT_ARM_STORE(field, reg) \
    plawnekjx_agent_context_emit_arm_store_reg_in_ctx_value (G_STRUCT_OFFSET (PlawnekjxAgentContext, field), ARM_REG_##reg, &ctx->tw)
...
static void
plawnekjx_agent_context_emit_arm_mach_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx)
{
  const gchar * again = "again";
...
static void
plawnekjx_agent_context_emit_arm_pthread_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx)
{
  const gchar * skip_construction = "skip_construction";
  const gchar * skip_dlopen = "skip_dlopen";
  const gchar * skip_destruction = "skip_destruction";
  ...
  gum_thumb_writer_put_cmp_reg_imm (&ctx->tw, ARM_REG_R0, PLAWNEKJX_UNLOAD_POLICY_IMMEDIATE);
  ...
  EMIT_ARM_LOAD (R0, unload_policy);
  gum_thumb_writer_put_cmp_reg_imm (&ctx->tw, ARM_REG_R0, PLAWNEKJX_UNLOAD_POLICY_DEFERRED);
...
static void
plawnekjx_agent_context_emit_arm_load_reg_with_ctx_value (arm_reg reg, guint field_offset, GumThumbWriter * tw)
{
...
static void
plawnekjx_agent_context_emit_arm_store_reg_in_ctx_value (guint field_offset, arm_reg reg, GumThumbWriter * tw)
{
  arm_reg tmp_reg = (reg != ARM_REG_R0) ? ARM_REG_R0 : ARM_REG_R1;
  gum_thumb_writer_put_push_regs (tw, 1, tmp_reg);
  gum_thumb_writer_put_ldr_reg_u32 (tw, tmp_reg, field_offset);
...
static void
plawnekjx_agent_context_emit_arm64_mach_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper)
{
  PlawnekjxAgentEmitContext ctx;
  ...
  plawnekjx_agent_context_emit_arm64_mach_stub_body (self, &ctx);
...
static void
plawnekjx_agent_context_emit_arm64_pthread_stub_code (PlawnekjxAgentContext * self, guint8 * code, GumDarwinModuleResolver * resolver,
    GumDarwinMapper * mapper)
{
  PlawnekjxAgentEmitContext ctx;
  ...
  plawnekjx_agent_context_emit_arm64_pthread_stub_body (self, &ctx);
  gum_arm64_writer_put_pop_reg_reg (&ctx.aw, ARM64_REG_X19, ARM64_REG_X20);
  gum_arm64_writer_put_pop_reg_reg (&ctx.aw, ARM64_REG_FP, ARM64_REG_LR);
  gum_arm64_writer_put_ret (&ctx.aw);
  gum_arm64_writer_clear (&ctx.aw);
...
#define EMIT_ARM64_LOAD(reg, field) \
    gum_arm64_writer_put_ldr_reg_reg_offset (&ctx->aw, ARM64_REG_##reg, ARM64_REG_X20, G_STRUCT_OFFSET (PlawnekjxAgentContext, field))
#define EMIT_ARM64_LOAD_ADDRESS_OF(reg, field) \
    gum_arm64_writer_put_add_reg_reg_imm (&ctx->aw, ARM64_REG_##reg, ARM64_REG_X20, G_STRUCT_OFFSET (PlawnekjxAgentContext, field))
...
#define EMIT_ARM64_STORE(field, reg) \
    gum_arm64_writer_put_str_reg_reg_offset (&ctx->aw, ARM64_REG_##reg, ARM64_REG_X20, G_STRUCT_OFFSET (PlawnekjxAgentContext, field))
...
static void
plawnekjx_agent_context_emit_arm64_mach_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx)
{
  const gchar * again = "again";
...
static void
plawnekjx_agent_context_emit_arm64_pthread_stub_body (PlawnekjxAgentContext * self, PlawnekjxAgentEmitContext * ctx)
{
  const gchar * skip_construction = "skip_construction";
  const gchar * skip_dlopen = "skip_dlopen";
  const gchar * skip_destruction = "skip_destruction";
  ...
  gum_arm64_writer_put_ldr_reg_u64 (&ctx->aw, ARM64_REG_X1, PLAWNEKJX_UNLOAD_POLICY_IMMEDIATE);
  ...
  EMIT_ARM64_LOAD (W0, unload_policy);
  gum_arm64_writer_put_ldr_reg_u64 (&ctx->aw, ARM64_REG_X1, PLAWNEKJX_UNLOAD_POLICY_DEFERRED);
  gum_arm64_writer_put_cmp_reg_reg (&ctx->aw, ARM64_REG_W0, ARM64_REG_W1);
...
static gboolean
plawnekjx_convert_thread_state_for_task (mach_port_t task, thread_state_flavor_t flavor, gconstpointer in_state,
    ...
    GError ** error)
{
  ...
  kr = plawnekjx_convert_thread_state (threads[0], PLAWNEKJX_CONVERT_THREAD_STATE_OUT, flavor, in_state, in_state_count,
...
static mach_port_t
plawnekjx_obtain_thread_port_for_thread_id (mach_port_t task, uint64_t thread_id)
{
...
static kern_return_t
plawnekjx_get_thread_state (mach_port_t thread, thread_state_flavor_t flavor, gpointer state, mach_msg_type_number_t * count)
{
  kern_return_t kr;

  kr = thread_get_state (thread, flavor, state, count);
  if (kr == KERN_SUCCESS)
    kr = plawnekjx_convert_thread_state_inplace (thread, PLAWNEKJX_CONVERT_THREAD_STATE_IN, flavor, state, count);

  return kr;
}

static kern_return_t
plawnekjx_set_thread_state (mach_port_t thread, thread_state_flavor_t flavor, gconstpointer state, mach_msg_type_number_t count)
{
  kern_return_t kr;
  ...
  kr = plawnekjx_convert_thread_state (thread, PLAWNEKJX_CONVERT_THREAD_STATE_OUT, flavor, state, count, remote_state, &count);
  if (kr == KERN_SUCCESS)
...
static kern_return_t
plawnekjx_get_debug_state (mach_port_t thread, gpointer state, GumCpuType cpu_type)
{
  ...
  return plawnekjx_get_thread_state (thread, flavor, state, &count);
}

static kern_return_t
plawnekjx_set_debug_state (mach_port_t thread, gconstpointer state, GumCpuType cpu_type)
{
  thread_state_flavor_t flavor;
  mach_msg_type_number_t count;
  ...
  return plawnekjx_set_thread_state (thread, flavor, state, count);
}

static kern_return_t
plawnekjx_convert_thread_state_inplace (mach_port_t thread, PlawnekjxConvertThreadStateDirection direction, thread_state_flavor_t flavor,
    gpointer state, mach_msg_type_number_t * count)
{
  return plawnekjx_convert_thread_state (thread, direction, flavor, state, *count, state, count);
}

static kern_return_t
plawnekjx_convert_thread_state (mach_port_t thread, PlawnekjxConvertThreadStateDirection direction, thread_state_flavor_t flavor,
    gconstpointer in_state, mach_msg_type_number_t in_state_count,
    gpointer out_state, mach_msg_type_number_t * out_state_count)
{
  static gboolean initialized = FALSE;
  static kern_return_t (* convert) (thread_act_t thread, PlawnekjxConvertThreadStateDirection direction, thread_state_flavor_t flavor,
...
static void
plawnekjx_set_nth_hardware_breakpoint (gpointer state, guint n, GumAddress break_at, GumCpuType cpu_type)
{
#ifdef HAVE_I386
...
#else
# define PLAWNEKJX_S_USER ((uint32_t) (2u << 1))
# define PLAWNEKJX_BAS_ANY ((uint32_t) 15u)
# define PLAWNEKJX_BAS_THUMB ((uint32_t) 12u)
# define PLAWNEKJX_BCR_ENABLE ((uint32_t) 1u)
  ...
  if (cpu_type == GUM_CPU_ARM64)
  {
    ...
    s->__bvr[n] = break_at;
    if (break_at != 0)
      s->__bcr[n] = (PLAWNEKJX_BAS_ANY << 5) | PLAWNEKJX_S_USER | PLAWNEKJX_BCR_ENABLE;
    else
      s->__bcr[n] = 0;
  }
  else
  {
    ...
    uint32_t bas = (break_at & 1) ? PLAWNEKJX_BAS_THUMB : PLAWNEKJX_BAS_ANY;

    s->__bvr[n] = break_at;
    if (break_at != 0)
      s->__bcr[n] = (bas << 5) | PLAWNEKJX_S_USER | PLAWNEKJX_BCR_ENABLE;
    else
      s->__bcr[n] = 0;
  }
#endif
...
static void
plawnekjx_set_hardware_single_step (gpointer debug_state, GumDarwinUnifiedThreadState * thread_state, gboolean enabled, GumCpuType cpu_type)
{
#ifdef HAVE_I386
# define PLAWNEKJX_SINGLE_STEP_ENABLED 0x0100
  ...
  if (cpu_type == GUM_CPU_AMD64)
  {
    ...
    if (enabled)
      state->__rflags |= PLAWNEKJX_SINGLE_STEP_ENABLED;
    else
      state->__rflags &= ~PLAWNEKJX_SINGLE_STEP_ENABLED;
  }
  else
  {
    ...
    if (enabled)
      state->__eflags |= PLAWNEKJX_SINGLE_STEP_ENABLED;
    else
      state->__eflags &= ~PLAWNEKJX_SINGLE_STEP_ENABLED;
  }
#else
# define PLAWNEKJX_SINGLE_STEP_ENABLED ((uint32_t) 1u)
  ...
  if (cpu_type == GUM_CPU_ARM64)
  {
    ...
    if (enabled)
      s->__mdscr_el1 |= PLAWNEKJX_SINGLE_STEP_ENABLED;
    else
      s->__mdscr_el1 = 0;
  }
  else
...
static gboolean
plawnekjx_is_hardware_breakpoint_support_working (void)
{
#if defined (HAVE_IOS) || defined (HAVE_TVOS) || defined (HAVE_XROS)
...
static GumAddress
plawnekjx_find_run_initializers_call (mach_port_t task, GumCpuType cpu_type, GumAddress start)
{
  GumAddress match = 0;
  ...
  capstone = plawnekjx_create_capstone (cpu_type, start);
...
static GHashTable *
plawnekjx_find_modinit_strcmp_checks (mach_port_t task, GumDarwinModule * dyld)
{
  GHashTable * checks;
  ...
  capstone = plawnekjx_create_capstone (dyld->cpu_type, modinit_start);
...
static GumAddress
plawnekjx_find_function_end (mach_port_t task, GumCpuType cpu_type, GumAddress start, gsize max_size)
{
  GumAddress match = 0;
  uint64_t address = start & ~G_GUINT64_CONSTANT (1);
  csh capstone;
...
static csh
plawnekjx_create_capstone (GumCpuType cpu_type, GumAddress start)
{
  csh capstone;
  cs_err err;
...
static gboolean
plawnekjx_parse_aslr_option (GVariant * value, PlawnekjxAslr * aslr, GError ** error)
{
  const gchar * str;
  ...
  if (strcmp (str, "auto") == 0)
    *aslr = PLAWNEKJX_ASLR_AUTO;
  else if (strcmp (str, "disable") == 0)
    *aslr = PLAWNEKJX_ASLR_DISABLE;
  else
    goto invalid_value;
...
static void
plawnekjx_mapper_library_blob_deallocate (PlawnekjxMappedLibraryBlob * self)
{
  mach_vm_deallocate (mach_task_self (), self->address, self->allocated_size);

  plawnekjx_mapped_library_blob_free (self);
}
